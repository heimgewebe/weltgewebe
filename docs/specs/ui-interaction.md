...
- die Bedeutungen werden sichtbar und deterministisch geordnet. Eine belegte notwendige Handlung steht zuerst. Eine freiwillige Beteiligungsmöglichkeit mit echter Fachfrist innerhalb der nächsten 24 Stunden darf danach vor bloß neuer Information stehen; dieser 24-Stunden-Horizont ist ausschließlich eine Darstellungsregel und kein neuer Fachzustand. Danach folgen Neu für dich und übrige Mitwirkung möglich. Innerhalb zeitkritischer Beteiligung entscheidet die frühere reale Frist, sonst die jüngste fachlich relevante Änderung; bei Gleichstand entscheidet die stabile Identität;
