...
> **Hinweis:** Diese Blaupause ist eine ältere, an [ADR-0005](../adr/ADR-0005-auth.md) gebundene Implementierungslinie und nicht mehr das kanonische Zieldokument. Siehe [ADR-0006](../adr/ADR-0006__auth-magic-link-session-passkey.md) und die [Auth Roadmap](../blueprints/auth-roadmap.md) für die aktuelle Architektur.
