...
| DEPLOY-DNS-001 | infra | INWX Registrar/DNS Cutover vorbereiten und durchführen | partial | high | `docs/adr/ADR-0008__domain-mail-provider-boundaries.md`, `docs/deploy/domain-mail-migration-ionos-to-inwx-mailbox-brevo.md`, `docs/runbooks/domain-mail-cutover.md`, `docs/reports/inwx-zone-reconciliation-plan.md`, externe Audit-Artefakte (keine privaten Rohdaten im Repo) | weltweb.net ist auf INWX delegiert; permanenter Redirect auf weltgewebe.net funktioniert; weltweberei.org ist auf INWX delegiert; Informationsseite funktioniert; beide Domains besitzen öffentlich und autoritativ belegte No-Mail-Records; danach Taskabschluss prüfen. |
