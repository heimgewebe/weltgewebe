...
| AGENT-SAFE-006 | governance | Deterministischen Read-only-Dry-Run-Runner mit funktionalem Readiness-Gate einführen | partial | high | `scripts/agent/run_task.py`, `scripts/agent/tests/test_run_task.py`, `scripts/docmeta/generate_agent_readiness.py`, `scripts/docmeta/tests/test_generate_agent_readiness.py`, `scripts/docmeta/tests/test_agent_readiness_smoke_contract.py`, `.github/workflows/agent-safety-preflight.yml`, `docs/reference/agent-dry-run-runner.md` | Dieser Slice fuehrt read-only Planung, Handoff-Bilanz, persistente Git-Zustandsdrift-Erkennung und funktionalen Readiness-Smoke ein; Run-Evidence und Write Mode bleiben offen |
