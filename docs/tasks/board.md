...
|---|---|---|---|---|---|---|
| OPT-CI-005 | ci | Node-24 Runtime Readiness | partial | high | `.github/workflows/`, `scripts/ci/check_actions_node24_readiness.py` | PR-CI-Lauf mit erzwungener Node-24-Action-Runtime prüfen; verbleibende Node-20-Metadatenwarnungen für Stage B erfassen |
| DOCMETA-FRESHNESS-001 | docs | DOCMETA-FRESHNESS-001 | partial | high | `docs/doc-freshness-registry.yml`, `docs/claims/README.md`, `scripts/docmeta/validate_doc_freshness_registry.py` |  |
| DEPLOY-DNS-001 | infra | INWX Registrar/DNS Cutover vorbereiten und durchführen | open | high | `docs/adr/ADR-0008__domain-mail-provider-boundaries.md`, `docs/deploy/domain-mail-migration-ionos-to-inwx-mailbox-brevo.md`, `docs/runbooks/domain-mail-cutover.md`, `docs/reports/inwx-zone-reconciliation-plan.md`, externe Audit-Artefakte (keine privaten Rohdaten im Repo) | INWX-Zone aus aktueller IONOS-Zone vorbereiten; Zonenvergleich, Web-Rollenentscheidung und Nameserver-Cutover-Gates dokumentieren; keine IONOS-Kündigung vor Registrar/DNS/Web-Proof |
