...
|---|---|---|---|
| OPT-ARC-001 | Edge-Writes, Step-up-E-Mail-Persistenz und WebAuthn-User-ID-Writeback offen; Runtime-Smoke und Cutover ausstehend | Offene Migrationsteile umsetzen bzw. Cutover-Proof vorbereiten | JSONL bleibt Default-Lesequelle und Write-Truth bis vollständiger Cutover; POST /accounts und PATCH /nodes schreiben optional PostgreSQL; fünf DB-Proof-Jobs sind in PR-CI grün (Run 27054400152) |
