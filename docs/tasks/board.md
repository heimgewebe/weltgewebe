...
|---|---|---|---|---|---|---|
| DOCMETA-REPORT-LIFECYCLE-001 | docs | Report-Lifecycle-Rollout reconciliieren und Restbestand ratcheten | partial | medium | `docs/process/report-lifecycle.md`, `docs/process/report-lifecycle-contract-alignment.md`, `scripts/docmeta/validate_report_lifecycle.py`, `.github/workflows/docs-guard.yml`, `docs/reports/report-lifecycle-restbestand-triage.md` | Restbestand (8 Reports) in `docs/reports/report-lifecycle-restbestand-triage.md` evidenzbasiert triagiert (je Fall Klassifikation oder begründete Leerstelle); nächste Aktion: Frontmatter-Backfill in kleinen Slices in Reihenfolge A→E (A: R8 Auth decision-prep; B: R2/R4 DNS-Cutover; C: R3 DB-Runtime; D: R5/R6 Map-Governance offen; E: R1 Cost-Generator); changed-only/global strict bleiben nachgelagert |
