...
| AGENT-SAFE-001 | governance | Safety-Preflight Guard minimal einführen | open | high | `docs/blueprints/blueprint-agent-safety-control-layer.md`, `docs/roadmap.md`, `docs/tasks/index.json` | Ordnungs-PR abgeschlossen; Implementierungs-PR für `agent/safety-preflight` zuschneiden, ohne daraus Done-Claims für spätere Slices abzuleiten |
| AGENT-SAFE-002 | governance | Readiness Hard Fail für Agent-Fähigkeiten einführen | open | high | `docs/blueprints/blueprint-agent-safety-control-layer.md`, `docs/roadmap.md`, `docs/tasks/index.json` | Nach `AGENT-SAFE-001` einen separaten Slice für `agent/readiness-hard-fail` planen; fehlende Capability soll blockieren statt still zu degradieren |
| AGENT-SAFE-003 | governance | Minimale Claim-Evidence-Spine aufbauen | open | high | `docs/blueprints/blueprint-agent-safety-control-layer.md`, `docs/roadmap.md`, `docs/tasks/index.json` | Eigenen Slice für `evidence/minimal-claim-spine` vorbereiten; Claim-Registry erst bei Implementierung anlegen |
| AGENT-SAFE-004 | governance | Minimale Agent-Contracts und Non-Ideal-Guard einführen | open | high | `docs/blueprints/blueprint-agent-safety-control-layer.md`, `docs/roadmap.md`, `docs/tasks/index.json` | Nach Claim-Spine einen Slice für `agent/minimal-contracts-and-guard` vorbereiten; Contracts und Guard erst im Umsetzungs-PR anlegen |
| TASK-CTL-004 | docs | Guard gegen uneingeordnete Blueprints und Pläne einführen | open | medium | `docs/blueprints/blueprint-agent-safety-control-layer.md`, `docs/roadmap.md`, `docs/tasks/index.json` | Check-only Registration-Guard im Report-only-Modus vorbereiten, damit neue Planungsartefakte nicht frei im Dokumentennebel schweben |
