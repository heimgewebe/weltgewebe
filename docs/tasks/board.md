...
|---|---|---|---|---|---|---|
| DOCMETA-REPORT-LIFECYCLE-001 | docs | Report-Lifecycle-Rollout reconciliieren und Restbestand ratcheten | partial | medium | `docs/process/report-lifecycle.md`, `docs/process/report-lifecycle-contract-alignment.md`, `scripts/docmeta/validate_report_lifecycle.py`, `.github/workflows/docs-guard.yml`, `docs/reports/report-lifecycle-restbestand-triage.md` | Slice A und Slice B sind abgeschlossen; als nächstes folgt Slice C; verbleibende unklassifizierte Reports: 5 (laut generiertem Overview). |
...
| AGENT-SAFE-008 | governance | Minimalen Generated-Artifact-Kontrollvertrag einführen | partial | high | `.wgx/generated-artifacts.yml`, `scripts/docmeta/validate_generated_artifacts.py`, `scripts/docmeta/tests/test_validate_generated_artifacts.py`, `scripts/docmeta/generate_agent_readiness.py`, `scripts/docmeta/generated-files-guard.sh`, `.github/workflows/docs-guard.yml`, `docs/reference/generated-artifact-control.md` | Manifest, Validator, schreibfreie Checks und Guard-Anbindung sind im Implementierungsbranch vorhanden; PR-CI, Merge und post-merge Verifikation stehen aus. Vollausbau auf alle Generated-Artefakte bleibt PR 13 |
