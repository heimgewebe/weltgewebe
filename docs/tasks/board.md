...
| DEPLOY-DNS-002 | infra | INWX-Zonenaufbau operativ vorbereiten und Pre-Delegation-Check | done | high | `docs/tasks/DEPLOY-DNS-001B.md`, externe Audit-Artefakte | Operator trägt INWX-Zonen manuell ein und füllt Pre-Delegation-Proof aus |
