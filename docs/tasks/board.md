...
| TASK-CTL-004 | docs | Guard gegen uneingeordnete Blueprints und Pläne einführen | done | medium | `scripts/docmeta/check_planning_registration.py`, `.github/workflows/task-index.yml` | - |
