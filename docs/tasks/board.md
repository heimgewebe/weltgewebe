...
|---|---|---|---|---|---|---|
| DOCMETA-REPORT-LIFECYCLE-001 | docs | Report-Lifecycle-Rollout reconciliieren und Restbestand ratcheten | partial | medium | `docs/process/report-lifecycle.md`, `docs/process/report-lifecycle-contract-alignment.md`, `scripts/docmeta/validate_report_lifecycle.py`, `.github/workflows/docs-guard.yml`, `docs/reports/report-lifecycle-restbestand-triage.md` | Restbestand (8 Reports) evidenzbasiert triagiert; nächste Aktion: Frontmatter-Backfills in kleinen Slices A→F: A R8 Auth Decision-Prep mit verbleibender Owner-Bestätigung; B R2/R4 DNS-Cutover; C R3 DB-Runtime; D R5/R6 Map-Governance; E R7 querschnittliche Optimierungsdiagnose mit offener Owner-Entscheidung; F R1 Cost-Generator. Changed-only/global strict bleiben nachgelagert |
