...
| AGENT-SAFE-002 | governance | Readiness Hard Fail für Agent-Fähigkeiten einführen | partial | high | `scripts/docmeta/generate_agent_readiness.py`, `scripts/docmeta/tests/test_generate_agent_readiness.py`, `docs/tasks/index.json` | Deterministische Capability-Matrix liefern und `overall=pass` verhindern, solange Hard-Capabilities fehlen; Implementierung dieser Hard-Capabilities bleibt in Folge-Slices |
