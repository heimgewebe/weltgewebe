...
| DEPLOY-DNS-001 | infra | INWX Registrar/DNS Cutover vorbereiten und durchführen | partial | high | `docs/reports/domain-provider-role-finding.md`, `docs/deploy/domain-mail-migration-ionos-to-inwx-mailbox-brevo.md`, `docs/adr/ADR-0008__domain-mail-provider-boundaries.md`, externe Audit-Artefakte (keine privaten Rohdaten im Repo) | Nächster Ergebnis-Schnitt: weltweb.net auf INWX delegieren und permanenten Redirect auf weltgewebe.net belegen; weltweberei.org auf INWX delegieren und Informationsseite belegen; für beide Domains No-Mail-Records autoritativ und öffentlich nachweisen; danach Taskabschluss prüfen. |
