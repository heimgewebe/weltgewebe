...
- [~] Phase 3 — Step-up Auth · Passkey-Register-Grant-Handoff belegt; positiver Register-Verify-Pfad lokal bewiesen (`LOCAL_PROOF_ONLY`), verpflichtender CI-Proof und UI-E2E weiter offen (`READY_FOR_CI_PROOF`) · [auth-roadmap §7/§8](blueprints/auth-roadmap.md)
