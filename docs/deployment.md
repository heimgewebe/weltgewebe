...
3. **Build Diagnosis**: A machine-readable `version.json` generated by the frontend build process is predictably exposed at `/_app/version.json`. This provides an accessible ID capable of diagnosing client-vs-server build discrepancies.
