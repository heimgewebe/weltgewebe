...
Nach ADR-0007 ist dies keine Produktionsvoraussetzung: Der Produktionspfad für Auth-
...
#### Status: offen für Dev-/Spezialpfad; keine Produktionsvoraussetzung nach ADR-0007
...
Er ist aber keine Produktionsvoraussetzung und blockiert `DbSessionStore` gegen direkten
