...
| OPT-FE-003 | Frontend | Panel-Detail-Fetch-Logik extrahieren | open | code | niedrig | mittel | niedrig | `apps/web/src/lib/components/panels/{NodePanel,AccountPanel,EdgePanel}.svelte` | fehlt | ~3× duplizierte Fetch-/Abort-/Loading-Logik; keine geteilte Utility | 2026-05-25 |
