...
| OPT-API-003 | API | DB-Migrationen | partial | code | hoch | niedrig | hoch | `apps/api/migrations/`, `apps/api/README.md` | `apps/api/migrations/20260428000000_create_sessions.{up,down}.sql` | Migrationsdateien und Doku vorhanden; CI-Pflichtpfad, Startup-Integration und Runtime-Verifikation fehlen | 2026-04-28 |
