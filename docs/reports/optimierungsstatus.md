...
| OPT-API-005 | API | Login-E-Mail Längenbegrenzung | open | code | niedrig | niedrig | niedrig | `apps/api/src/routes/auth.rs` (nur `contains('@')`-Prüfung) | fehlt | Keine `maxLength` vor Hash/Store; axum-Body-Limit begrenzt Restrisiko | 2026-05-25 |
