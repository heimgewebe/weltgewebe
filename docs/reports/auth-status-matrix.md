...
**Statusformulierung:** Phase 5 DbSessionStore CI proof PROVEN; Phase 6 Cookie-Proof CI PROVEN; remaining auth/browser/passkey proofs pending where applicable.
