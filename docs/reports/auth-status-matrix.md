...
| Session                | required    | PostgreSQL-/In-Memory-Sessionvertrag mit konfigurierbarer TTL; PostgreSQL ist Zeitautorität für persistierte Sessions; Chromium-Profil-, Neustart-, Isolations- und serverseitiger Logout-Proof auf Vorläufer-Head `dae24373` in GitHub CI grün; Review-Nachbesserung lokal grün, erneuter CI-Lauf ausstehend                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Teil   | niedrig bis mittel |
...
**Issue-#1378-Vorbeleg auf dem vorigen Implementierungs-Head:** Workflow `Auth Session Persistence Proof`, Run-ID [`29110820445`](https://github.com/heimgewebe/weltgewebe/actions/runs/29110820445), Job `auth session persistence browser proof`/Job-ID [`86422456701`](https://github.com/heimgewebe/weltgewebe/actions/runs/29110820445/job/86422456701), headSha `dae243734779719574fa11207e8802929f9c70d9`, Ergebnis `success`. Derselbe Head bestand im Workflow `api` den Job `db session persistence proof (direct postgres)` (Run-ID [`29110820561`](https://github.com/heimgewebe/weltgewebe/actions/runs/29110820561), Job-ID [`86422457128`](https://github.com/heimgewebe/weltgewebe/actions/runs/29110820561/job/86422457128)) sowie `cookie session proof (phase 6)` (Job-ID [`86422457218`](https://github.com/heimgewebe/weltgewebe/actions/runs/29110820561/job/86422457218)). Der für die Evidence- und Generatoroberfläche relevante Docs-Guard bestand im Workflow `Docs Guard` (Run-ID [`29110820430`](https://github.com/heimgewebe/weltgewebe/actions/runs/29110820430), Job `Blocking doc validations`/Job-ID [`86422456454`](https://github.com/heimgewebe/weltgewebe/actions/runs/29110820430/job/86422456454)). Beweisgrenze: Der Browser-Proof verwendet einen Integrationstest-Bootstrap gegen eine lokale HTTP-API; er beweist keine reale Mailzustellung, kein produktives TLS-Terminal und keinen manuellen Login über einen externen Mailclient.
**Statusformulierung:** DbSessionStore-, Cookie- und gehärteter Issue-#1378-Chromium-Proof sind auf dem vorigen Implementierungs-Head CI-PROVEN; die anschließende PostgreSQL-Vertragspräzisierung ist lokal grün und benötigt noch den erneuten GitHub-CI-Beleg. Reale Mailzustellung, produktiver Browser-Live-Test und der weitergehende Token-Split bleiben offen.
