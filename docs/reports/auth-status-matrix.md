...
**Fehlende Belege:** Passkey-Management-UI/List/Remove; vollständiger Browser-/Authenticator-E2E für Register → Reload → Login; `webauthn_user_id`-Backfill/NOT-NULL (AUTH-PG-003). Runtime-Facade und Config-Gate sind vorbereitet, bleiben aber bis Produktions-Cutover Teilstatus von AUTH-PG-002.
**Status:** Teil
**Risiko:** mittel
