...
| Session                | required    | PostgreSQL-/In-Memory-Sessionvertrag mit konfigurierbarer TTL; PostgreSQL ist Zeitautorität für persistierte Sessions; Chromium-Profil-, Neustart-, Isolations- und serverseitiger Logout-Proof auf Code-Head `dae24373` in GitHub CI grün                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Teil   | niedrig bis mittel |
