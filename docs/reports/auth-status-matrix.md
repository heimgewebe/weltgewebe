...
| Sicherheitsinvarianten| required    | Codepfade für alle fünf Aspekte implementiert; Anti-Enumeration-Parität und systematische CSRF-Abdeckung aller aktuell gelisteten CSRF-pflichtigen mutierenden Endpunkte reproduzierbar belegt (Phase 7); Rate-Limit-Runtime-Smoke und End-to-End-Token-Leak-Test offen | Teil   | mittel  |
