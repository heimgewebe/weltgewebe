...
**Fehlende Belege:** Passkey-Management-UI/List/Remove; repräsentativer Runtime-/Produktionsaudit vor FK-Migration; Produktions-Cutover; `webauthn_user_id`-Backfill/NOT-NULL (AUTH-PG-003). Store, Runtime-Facade, Browser-Route-Proof und CI-FK-Audit sind vorbereitet, bleiben aber bis Produktions-Cutover Teilstatus von AUTH-PG-002.
**Status:** Teil
**Risiko:** mittel
