...
|specs.governance-antraege|docs/specs/governance-antraege.md|norm|governance|canonical|2026-07-20|specs.garnrolle-knoten-faden|apps/api/tests/api_governance_guards.rs, apps/api/tests/db_governance.rs, apps/web/src/lib/api/governance.test.ts, apps/web/tests/governance.spec.ts, apps/web/tests/proofs/governance-full-flow.proof.ts||
...
|specs.private-nachrichten|docs/specs/private-nachrichten.md|norm|product|canonical|2026-07-30|specs.garnrolle-knoten-faden|apps/api/src/routes/conversations.rs, apps/api/tests/db_node_conversations.rs, apps/web/src/lib/api/directMessages.ts, apps/web/src/routes/nachrichten/+page.svelte||
|specs.ui-interaction|docs/specs/ui-interaction.md|norm|product-ui|canonical|2026-07-27|specs.ui-state-machine, specs.garnrolle-knoten-faden|apps/web/src/lib/components/ContextPanel.svelte, apps/web/src/lib/components/FilterOverlay.svelte, apps/web/src/lib/components/GovernanceFan.svelte, apps/web/src/lib/components/SearchOverlay.svelte, apps/web/src/lib/components/ToolFan.svelte, apps/web/src/lib/stores/mapChrome.ts, apps/web/tests/context-panel-sheet.spec.ts, apps/web/tests/map-interaction.spec.ts, apps/web/tests/tool-fan-layout.spec.ts, apps/web/tests/ui-filter.spec.ts, apps/web/tests/ui-search.spec.ts||
