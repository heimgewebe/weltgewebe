...
|id|path|role|organ|status|last_reviewed|depends_on|verifies_with|missing_scripts|
|---|---|---|---|---|---|---|---|---|
|specs.garnrolle-knoten-faden|docs/specs/garnrolle-knoten-faden.md|norm|product-domain|canonical|2026-07-13||apps/web/tests/garnrolle-self-service.spec.ts, apps/web/tests/komposition.spec.ts, contracts/domain/account.schema.json, contracts/domain/edge.schema.json, contracts/domain/node.schema.json||
