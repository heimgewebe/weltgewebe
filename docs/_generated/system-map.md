...
|specs.governance-antraege|docs/specs/governance-antraege.md|norm|governance|canonical|2026-08-08|specs.garnrolle-knoten-faden|apps/api/tests/api_governance_guards.rs, apps/api/tests/db_governance.rs, apps/web/src/lib/api/governance.test.ts, apps/web/tests/governance.spec.ts, apps/web/tests/proofs/governance-full-flow.proof.ts||
|specs.knoten-gewebe-visualisierung|docs/specs/knoten-gewebe-visualisierung.md|norm|product-map|canonical|2026-08-06|specs.garnrolle-knoten-faden, specs.map-experience|apps/web/src/lib/map/overlay/edges.test.ts, apps/web/src/lib/map/overlay/edges.ts, apps/web/src/lib/map/overlay/nodes.test.ts, apps/web/src/lib/map/overlay/nodes.ts, apps/web/src/lib/map/overlay/weaveRuntime.ts, apps/web/src/lib/map/weaveModel.test.ts, apps/web/src/lib/map/weaveModel.ts, apps/web/src/lib/map/weaveTheme.ts, apps/web/tests/garnrolle-marker-rendering.spec.ts, apps/web/tests/woven-node-visualization.spec.ts||
