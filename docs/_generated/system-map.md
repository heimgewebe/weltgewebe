...
|specs.map-experience|docs/specs/map-experience.md|norm|product-map|canonical|2026-08-02|specs.ui-interaction, specs.ui-state-machine, specs.garnrolle-knoten-faden|apps/web/src/lib/map/scene.ts, apps/web/src/lib/map/types.ts, apps/web/src/routes/map/+page.svelte, apps/web/src/routes/map/+page.ts, apps/web/tests/edge-visibility.spec.ts, apps/web/tests/map-load-fallback.spec.ts, apps/web/tests/map-url-state.spec.ts||
...
|specs.ortsweberei-webgemeindezentrum|docs/specs/ortsweberei-webgemeindezentrum.md|norm|product-domain|canonical|2026-08-02|specs.garnrolle-knoten-faden, specs.governance-antraege|||
