...
|specs.garnrolle-knoten-faden|docs/specs/garnrolle-knoten-faden.md|norm|product-domain|canonical|2026-08-01||apps/api/tests/api_accounts.rs, apps/api/tests/api_governance_guards.rs, apps/api/tests/db_domain_edge_write_path.rs, apps/api/tests/db_node_conversations.rs, apps/web/src/lib/demo/resolvers.test.ts, apps/web/tests/garnrolle-relations.spec.ts, apps/web/tests/garnrolle-self-service.spec.ts, apps/web/tests/komposition.spec.ts, contracts/domain/account.schema.json, contracts/domain/edge.schema.json, contracts/domain/node.schema.json||
