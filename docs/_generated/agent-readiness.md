...
| handoff_validation | pass | yes | `contracts/agent/task.schema.json`, `contracts/agent/handoff.schema.json`, `scripts/agent/json_contract.py`, `scripts/agent/check_non_ideal_task.py`, `scripts/agent/validate_handoff.py`, `scripts/agent/tests/test_validate_handoff.py`, `scripts/docmeta/docmeta.py`, `scripts/docmeta/validate_claim_registry.py`, `tests/fixtures/agent/handoff-task.json`, `tests/fixtures/agent/handoff-valid.json` | - | Handoff-Checks begrenzen unvollstaendige oder unsichere Uebergaben. Required files and an isolated valid-fixture smoke both pass. |
