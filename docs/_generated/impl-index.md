...
| impl.platform.kubernetes-gitops | platform/README.md | platform | high | docs/adr/ADR-0010__kubernetes-kanonische-plattform.md, docs/reports/kubernetes-platform-foundation-status.md, runbooks/kubernetes-local-reference.md | scripts/platform/validate_platform.py, scripts/platform/kind_reference.py, scripts/ci/tests/test_kubernetes_platform_contract.py, .github/workflows/kubernetes-platform.yml | ci |
...
| impl.guard.kubernetes-platform | scripts/platform/validate_platform.py | guard | high | platform/README.md, docs/reports/kubernetes-platform-foundation-status.md | scripts/ci/tests/test_kubernetes_platform_contract.py, .github/workflows/kubernetes-platform.yml | ci |
