...
| impl.service.web | apps/web/ | service | high | apps/web/README.md, docs/blueprints/ui-blaupause.md, docs/blueprints/ui-roadmap.md, docs/deploy/secondary-domain-web-surfaces.md | .github/workflows/web.yml, apps/web/tests/smoke.home.spec.ts, apps/web/tests/weltweberei-information.spec.ts, apps/web/src/lib/stores/uiInvariants.test.ts | ci |
...
| impl.infra.caddy | infra/caddy/ | config | medium | docs/blueprints/map-blaupause.md | scripts/guard/caddy-basemap-route-guard.sh, scripts/guard/domain-single-instance-guard.sh, scripts/tests/test_domain_single_instance_guard.sh | guard |
