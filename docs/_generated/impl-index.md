...
| impl.guard.basemap-runtime-proof | scripts/guard/basemap-runtime-proof.sh | guard | medium | docs/specs/map-experience.md, docs/reports/map-status.md | .github/workflows/basemap-runtime-proof.yml | ci |
