...
| impl.contracts | contracts/ | schema | high | contracts/README.md, docs/specs/contract.md, docs/datenmodell.md | .github/workflows/contracts-domain.yml, scripts/contracts-domain-check.sh | ci |
