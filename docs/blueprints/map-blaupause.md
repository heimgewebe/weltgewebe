...
Aktuell nutzt die Implementierung MapLibre mit der lokalen souveränen PMTiles-Struktur als Standard.
Die Basemap wird lokal als echtes PMTiles-Artefakt simuliert bzw. aus dem Build konsumiert.
