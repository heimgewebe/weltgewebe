...
- **Offen:** grüner CI-Run des Jobs `auth-passkey-register-proof` (`READY_FOR_CI_PROOF`, CI job added; awaiting green run), persistente Account-Datenquelle für den `webauthn_user_id`-Writeback, Auth-Optionen/Verify, Passkey-Login/Management, UI
