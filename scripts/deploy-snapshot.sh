...
# -----------------------------
# (Note: Infra updates (Edge/Public Login/Trusted Proxy/Drift Fix/Caddy Rate Limit Disabled/Basemap CSP Fix) require the pinned Caddy build (see infra/caddy/Dockerfile) and a strict upstream env; ensure snapshot captures this context)
