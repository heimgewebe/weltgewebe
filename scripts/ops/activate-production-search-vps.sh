...
FRONTEND_VERSION_URL="${WELTGEWEBE_FRONTEND_VERSION_URL:-https://commonthing.net/_app/version.json}"
API_VERSION_URL="${WELTGEWEBE_API_VERSION_URL:-https://commonthing.net/api/version}"
SEARCH_URL="${WELTGEWEBE_SEARCH_URL:-https://commonthing.net/api/search}"
