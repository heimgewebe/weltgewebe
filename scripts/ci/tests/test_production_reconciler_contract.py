...
"""
    ...
    def test_vps_caddy_binding_is_public_and_fail_closed(self) -> None:
        ...
        self.assertIn('export CADDY_BIND="${CADDY_BIND:-${VPS_PUBLIC_CADDY_BINDS[0]}}"', up)
        self.assertIn('export CADDY_IPV6_BIND="${CADDY_IPV6_BIND:-${VPS_PUBLIC_CADDY_BINDS[1]}}"', up)
