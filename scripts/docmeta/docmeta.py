    ...
    for line in frontmatter_text.splitlines():
        ...
        if line.startswith(' ') and stripped_line.startswith('- ') and current_key:
            if current_key == 'relations':
                ...
                continue
            elif current_key in ['verifies_with', 'audit_gaps', 'depends_on', 'attention_source_facts', 'attention_projection', 'attention_transition_tests', 'attention_missing_facts']:
        ...
        if ':' in line:
            ...
            elif val == '' and key in ['relations', 'verifies_with', 'audit_gaps', 'depends_on', 'attention_source_facts', 'attention_projection', 'attention_transition_tests', 'attention_missing_facts']:
